...
private:
	struct FBodyRoute
	{
		TWeakObjectPtr<ABox3DInstancedBodyActor> Actor;
		int32 LocalBodyId = INDEX_NONE;
	};
	...
	ABox3DInstancedBodyActor* GetOrCreateOverflowActor();
	int32 SpawnBodyInThisActor(const FTransform& WorldTransform);
	...
	TArray<TWeakObjectPtr<ABox3DInstancedBodyActor>> OverflowActors;
	TWeakObjectPtr<ABox3DInstancedBodyActor> ActiveOverflowActor;
	TMap<int32, FBodyRoute> RoutedBodies;
	int32 NextBodyId = 1;
